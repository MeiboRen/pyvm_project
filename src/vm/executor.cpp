...
void executor::execute_frame() {
    ...
    while (_frames->is_code_ended()) {
        ...
        switch (op_code) {
            ...
            case byte_code::INPLACE_MULTIPLY:
                obj1 = _frames->stack()->pop();
                obj2 = _frames->stack()->pop();
            ...
            case byte_code::LOAD_BUILD_CLASS:
            ...
            case byte_code::UNPACK_SEQUENCE:
                obj1 = _frames->stack()->pop();
            ...
            case byte_code::STORE_GLOBAL:
                obj1 = _frames->names()->get(op_arg);
                _frames->globals()->put(obj1, _frames->stack()->pop());
                break;

            case byte_code::ROT_N:
            ...
            case byte_code::JUMP_IF_NOT_EXC_MATCH: {
